    ...
    class CarritoController {
        ...
        private function checkLogin() {
            ...
            if (!isset($_SESSION['id_usuario'])) {
                header(
                    "Location: index.php?controller=usuario&action=login"
                );
                exit;
            }
        }
        ...
        public function ver() {
            ...
            // carrito.
            $carrito = 
            $this->carritoModel->obtenerCarrito(
                $id_usuario
            );
        ...
        public function agregar() {
            ...
            // al carrito.
            $this->carritoModel->agregarAlCarrito(
                $id_usuario, 
                $id_producto
            );
            ...
            header(
                "Location: index.php?controller=carrito&action=ver&message=Producto+añadido+al+carrito"
            );
        }
        ...
        public function confirmarCompra() {
            ...
            $base_url = 
            "http://localhost/UT4_PY_VacaGarciaRichardFrancisco/public/";
            ...
            foreach ($carrito as $item) {
                ...
                "' style='max-width:100px; vertical-align:middle; margin-right:10px;'>" . 
            ...
            $contenido .= 
            "<p><strong>Total: €" . number_format(
                $total, 2
            ) . "</strong></p>";

            // 23. Configuración para enviar el correo 
            // con la API de Mailjet.
            $apiKeyPublic = 
            'b202e7778b9637602c4d8fb04b91c499';

            $apiKeyPrivate = 
            '80c87ad5670a6b953db04a462f117eef';
            ...
            if ($err) {
                $error = 
                "Lo siento, ha habido un error al enviar el recibo: $err";
            } 
            
            else {
                $message = 
                "Compra confirmada. El recibo ha sido enviado a tu correo.";
            }
        ...
        public function actualizarCantidad() {
            ...
            $id_carrito = 
            filtrarEntero($_POST['id_carrito'] ?? 0);

            $cantidadAEliminar = 
            filtrarEntero($_POST['cantidad'] ?? 0);

            // 29. Obtengo la línea del carrito para 
            // asegurarme de que pertenece al usuario.
            $linea = 
            $this->carritoModel->obtenerLineaCarrito(
                $id_carrito
            );
            ...
            if (
                $linea && $linea['id_usuario'] == 
                $_SESSION['id_usuario']
            ) {
                $nuevaCantidad = 
                $linea['cantidad'] - $cantidadAEliminar;
            ...
            header(
                "Location: index.php?controller=carrito&action=ver&message=Cantidad+actualizada"
            );
        }
    }
?>
