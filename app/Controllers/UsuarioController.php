<?php
    ...
    class UsuarioController {
        ...
        public function procesarLogin() {
            ...
            // según su email.
            $user = 
            $this->usuarioModel->obtenerPorEmail(
                $email
            );
        ...
        public function procesarRegistro() {
            ...
            if ($admin === 1) {
                if ($admin_password !== '000000') {
                    $error = 
                    "Contraseña de Admin incorrecta. No se ha registrado el usuario.";
                    require __DIR__ . 
                    '/../Views/usuarios/registro.php';
                    return;
                }
            ...
            if ($existe) {
                ...
                if ($this->usuarioModel->registrar(
                    ...
                    header(
                        "Location: index.php?controller=usuario&action=login&message=Usuario+registrado+con+éxito"
                    );
                } 
