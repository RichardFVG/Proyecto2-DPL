    ...
    class CarritoModel {
        ...
        public function agregarAlCarrito(
            ...
            if ($res->num_rows > 0) {
                ...
                $stmt = $this->conn->prepare($sql);
                $stmt->bind_param(
                    "iii", $cantidad, $id_usuario, $id_producto
                );
            } 
                ...
                $stmt = $this->conn->prepare($sql);
                $stmt->bind_param(
                    "iii", $id_usuario, $id_producto, $cantidad
                );
            }
            return $stmt->execute();
        }
        ...
        public function obtenerCarrito($id_usuario) {
            $sql = 
            "SELECT c.id_carrito, p.nombre, p.precio, p.imagen, c.cantidad 
            FROM carrito c
        ...
        // id_carrito.
        public function obtenerLineaCarrito(
            $id_carrito
        ) {
